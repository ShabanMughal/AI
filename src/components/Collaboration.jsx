    ...
    <Section crosses>
      <div className="container lg:flex ">
        <div className="max-w-[25rem]">
          ...
          <ul className="mmax-w-[22rem] mb-10 md:mb-14">
        ...
        <div className="lg:ml-auto xl:w-[38rem]">
          <p className="body-2 mb-4 text-n-4 md:mb-16 lg:mb-[7rem] lg:w-[22rem] lg:mx-auto mt-4">
            {collabText}
          </p>
          ...
          rounded-full -translate-x-1/2 scale-75 md:scale-100">
           ...
           <ul>{collabApps.map((app,index)=>(
            ...
            rotate-${index * 45}`}>
                <div className={`relative -top-[1.6rem] flex w-[3.2rem] border
                h-[3.2rem] rounded-xl -rotate-${index * 45} border-n-1/15 bg-n-7`}>
                <img className="m-auto"
                 src={app.icon} alt={app.title} width={app.width} height={app.height} />
                </div>
            </li>
           ))}</ul>
           <LeftCurve />
